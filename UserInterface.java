...
public class UserInterface implements ActionListener
{
     ...
     * @param pOnOff A boolean that shows if the entry field is enable or not
     */
    ...
    {
        this.aMyFrame = new JFrame( "Test" ); // change the title
        ...
        this.aMyFrame.getContentPane().add(aLookButton);
     ...
     * @param pE The ActionEvent
     */
    public void actionPerformed( final ActionEvent pE ) 
    {
        Object vSource=pE.getSource();
        if(vSource==aLookButton)
        {this.aEngine.look();}
